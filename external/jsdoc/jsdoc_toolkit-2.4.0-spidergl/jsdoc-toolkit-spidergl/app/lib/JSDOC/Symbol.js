...
JSDOC.Symbol.READ_WRITE = 0;
JSDOC.Symbol.READ_ONLY  = 1;
JSDOC.Symbol.WRITE_ONLY = 2;
...
JSDOC.Symbol.prototype.init = function() {
	...
	this.type = "";
	this.version = "";
	this.rwAccess = JSDOC.Symbol.READ_WRITE;
}
...
JSDOC.Symbol.prototype.setTags = function() {
	...
	*/
	...
	if (this.comment.getTag("readonly").length) {
		this.rwAccess = JSDOC.Symbol.READ_ONLY;
	}
	...
	*/
	...
	// @writeonly
	if (this.comment.getTag("writeonly").length) {
		this.rwAccess = JSDOC.Symbol.WRITE_ONLY;
	}
